...
.rating-word  { font-size: 1rem; font-weight: 700; color: #1a3a5c; }
...
.subcat-label { font-size: 0.75rem; color: #555; }
...
.empty-sub  { font-size: 0.85rem; color: #aaa; }
...
.review-card:hover { box-shadow: 0 4px 18px rgba(37,99,168,0.08); }

/* Badge rediseñado — número grande centrado */
.review-score-badge {
  background: #f4f7fb;
...
.review-body         { display: flex; flex-direction: column; gap: 4px; flex: 1; }
.review-rating-word  { font-size: 0.88rem; font-weight: 700; color: #1a3a5c; margin: 0; }
...
.read-more {
  ...
  color: #2563a8; cursor: pointer; padding: 0;
...
.reviewer-name { font-size: 0.8rem; font-weight: 600; color: #333; margin: 0; }
.reviewer-meta { font-size: 0.72rem; color: #888; margin: 0; }
.verified-tag  { font-size: 0.72rem; color: #2a7a4b; }

/* ── Ver todas ── */
.ver-todas-wrapper { display: flex; justify-content: center; margin-bottom: 2rem; }
.ver-todas-btn {
  padding: 0.6rem 2rem;
...
.success-msg {
  ...
  color: #2a7a4b; border-radius: 8px;
...
.rating-label { font-size: 0.82rem; color: #5a7a99; margin-left: 0.75rem; font-weight: 600; }
...
.review-textarea::placeholder { color: #aac4de; }

/* Footer del form — contador a la izquierda, botón a la derecha */
.form-footer {
  display: flex;
